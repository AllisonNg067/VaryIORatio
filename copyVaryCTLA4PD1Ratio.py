...
bed = 80
file_name = 'RT ' + str(RT_fractions) + ' PD ' + str(PD_fractions) + ' CTLA4 ' + str(CTLA4_fractions) + ' varied IO ratio c.csv'
...
#     print(params[k])
#ratios = [0, 0.5,0.75]
args = [(schedule, params, ratio) for schedule in range(50,min(iterations,75)) for ratio in ratios]
